...
class User(AbstractUser):
    ...
    academic_or_work_area = models.PositiveSmallIntegerField(
        choices=ACADEMIC_OR_WORK_AREA_CHOICES, null=True, blank=True, verbose_name="En qué área me he desarrollado a nivel académico / laboral"
    )
